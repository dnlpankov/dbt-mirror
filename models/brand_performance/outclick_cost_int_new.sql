...
(
    ...
    -- left join {{ref('stg_campaing_names_mapping__traffic_sources')}} sources
    -- on actions.campaign_name=sources.affiliate_campaign_name
    where  
...
(    select 
    ...
    group by day, country_code, campaign_name, ga_campaign_name, traffic_source, betting_type
)
